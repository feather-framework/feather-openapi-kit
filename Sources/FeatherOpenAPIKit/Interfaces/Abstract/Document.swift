...
//    func examples() -> OpenAPI.ComponentDictionary<OpenAPI.Example>
    ...
    func securitySchemes() -> OpenAPI.ComponentDictionary<OpenAPI.SecurityScheme>
    ...
    func securitySchemes() -> OpenAPI.ComponentDictionary<OpenAPI.SecurityScheme> {
        components.reduce(into: [:]) { into, item in
            for securityScheme in item.securitySchemes {
                into[securityScheme.componentKey] = securityScheme.openAPISecurityScheme()
            }
        }
    }
